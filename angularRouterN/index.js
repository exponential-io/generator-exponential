...
var AngularRouterNGenerator = module.exports = function AngularRouterNGenerator() {
...
util.inherits(AngularRouterNGenerator, _eGeneratorBase);

// Pre-cleanup downloadDir
AngularRouterNGenerator.prototype.preCleanup = _eCleanup;

/** Download the source files */
AngularRouterNGenerator.prototype.generateSrc = function generateSrc() {
    _eDownloadSource.apply(this, [{
        _eMkDirs: _eMkDirs,
        generator: 'angularRouterN'
    }]);
};

/** Create the Angular files - Routes */
AngularRouterNGenerator.prototype.angularServiceFiles = function angularRouterFiles() {
...
/** Cleanup downloadDir */
AngularRouterNGenerator.prototype.cleanupDownloadDir = _eCleanup;
